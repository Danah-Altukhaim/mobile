...
export const mockResponses: Record<string, any> = {
  ...
  '/api/v1/students/me/available-courses': {
    success: true,
    data: [
      { id: 'sec-101', course_code: 'CS201', name_ar: 'هياكل البيانات', name_en: 'Data Structures', credits: 3, prerequisites: ['CS101'], seats_available: 12, total_seats: 35, schedule: 'Sun/Tue 10:00-11:30', instructor_name_ar: 'د. أحمد المطيري', instructor_name_en: 'Dr. Ahmed Al-Mutairi' },
      { id: 'sec-102', course_code: 'CS202', name_ar: 'قواعد البيانات', name_en: 'Database Systems', credits: 3, prerequisites: ['CS101'], seats_available: 5, total_seats: 30, schedule: 'Mon/Wed 14:00-15:30', instructor_name_ar: 'د. نورة الدوسري', instructor_name_en: 'Dr. Noura Al-Dosari' },
      { id: 'sec-103', course_code: 'MATH301', name_ar: 'الإحصاء', name_en: 'Statistics', credits: 3, prerequisites: ['MATH201'], seats_available: 20, total_seats: 40, schedule: 'Sun/Tue 12:00-13:30', instructor_name_ar: 'د. فاطمة الراشد', instructor_name_en: 'Dr. Fatima Al-Rashid' },
      { id: 'sec-104', course_code: 'ENG201', name_ar: 'الكتابة الأكاديمية', name_en: 'Academic Writing', credits: 3, prerequisites: ['ENG102'], seats_available: 0, total_seats: 25, schedule: 'Mon/Wed 10:00-11:30', instructor_name_ar: 'أ. سارة العنزي', instructor_name_en: 'Ms. Sara Al-Enezi' },
      { id: 'sec-105', course_code: 'CS301', name_ar: 'هندسة البرمجيات', name_en: 'Software Engineering', credits: 3, prerequisites: ['CS201'], seats_available: 18, total_seats: 35, schedule: 'Sun/Tue 14:00-15:30', instructor_name_ar: 'د. محمد الشمري', instructor_name_en: 'Dr. Mohammed Al-Shammari' },
    ],
  },
