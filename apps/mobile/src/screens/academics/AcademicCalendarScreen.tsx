...
export function AcademicCalendarScreen() {
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: colors.background }]} contentContainerStyle={styles.content}>
      <Text variant="h2" style={[styles.title, { textAlign, writingDirection }]}>{t('academics.calendar')}</Text>
              ...
              <View style={[styles.row, { flexDirection: rowDirection }]}>
                ...
                <View style={styles.info}>
                  <View style={[styles.titleRow, { flexDirection: rowDirection }]}>
                    <Text variant="bodyBold" style={[styles.titleText, { textAlign, writingDirection }]}>
...
const styles = StyleSheet.create({
  ...
  iconWrap: {},
  info: { flex: 1 },
  titleRow: { alignItems: 'center', gap: spacing.sm, marginBottom: 2 },
