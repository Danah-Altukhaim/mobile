    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <ScrollView style={styles.flex1} contentContainerStyle={styles.scroll}>
        <View style={[styles.header, { backgroundColor: colors.primary }]}>
          <Text variant="h2" color={colors.textInverse}>{t('ai.courseRecommendations')}</Text>
          <Text variant="caption" color={colors.textInverse} style={styles.subtitle}>
...
const styles = StyleSheet.create({
  container: { flex: 1 },
  header: { padding: spacing.xl, paddingTop: spacing.xl, borderBottomLeftRadius: 24, borderBottomRightRadius: 24, marginHorizontal: -spacing.base },
  subtitle: { marginTop: spacing.xs, opacity: 0.8 },
  flex1: { flex: 1 },
