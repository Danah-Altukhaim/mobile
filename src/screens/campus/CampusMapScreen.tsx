...
export function CampusMapScreen() {
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: colors.background }]} contentContainerStyle={styles.content}>
      <Text variant="h2" style={styles.title}>{t('campus.map')}</Text>
...
const styles = StyleSheet.create({
  ...
  iconCircle: { width: 40, height: 40, borderRadius: 20, alignItems: 'center', justifyContent: 'center', marginEnd: spacing.md },
  buildingInfo: { flex: 1 },
